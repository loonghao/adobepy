...
def py_type(value: str) -> str:
    return re.sub(
        r"\b(Channel|CharacterStyle|Clip|Document|Layer|Link|Marker|Page|ParagraphStyle|Project|Selection|Sequence|Spread|Story|Swatch|TextFrame|TextItem|TextSelection|Track)\b",
        r"\1Proxy",
        value,
    )
